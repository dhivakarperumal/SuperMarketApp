  ...
  <View className="mb-4">
    ...
    <View
      className={`flex-row items-center rounded-full border bg-white px-4 ${
        focusedInput === inputKey ? "border-[#2E7D32]" : "border-[#E5E7EB]"
      }`}
      style={{ height: 54 }}
    >
      <Icon size={18} color={focusedInput === inputKey ? "#2E7D32" : "#9CA3AF"} />
      <TextInput
        value={value}
        ...
        <View className="flex-1 px-6 pb-6 pt-2">
          ...
          <View className="mt-7">
            ...
            <Text className="mt-4 px-2 text-center text-xs leading-5 text-slate-400">
              By signing up, you agree to our <Text className="font-semibold text-[#2E7D32]">Terms</Text> and <Text className="font-semibold text-[#2E7D32]">Privacy Policy</Text>.
            </Text>
            ...
            <View className="mt-5 flex-row justify-center">
              ...
              <Link href="/(auth)/login" asChild>
                <Pressable>
                  <Text className="font-semibold text-[#2E7D32]">Log in</Text>
                </Pressable>
              </Link>
            </View>
          </View>
