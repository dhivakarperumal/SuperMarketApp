    ...
    return (
      ...
      >
        ...
        <View style={{ padding: 12 }}>
          ...
          <Text style={{ color: isOutOfStock ? '#9ca3af' : '#2E7D32', fontWeight: '700', fontSize: 15, marginTop: 6 }}>
    ...
    >
      ...
      <View style={{ padding: 12, flex: 1, justifyContent: 'space-between' }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10 }}>
          <Text style={{ color: isOutOfStock ? '#9ca3af' : '#2E7D32', fontWeight: '700', fontSize: 16 }}>
            {formatCurrency(firstPrice)}
          </Text>
          <Pressable
            ...
            style={{
              width: 36,
              height: 36,
              backgroundColor: isOutOfStock ? '#D1D5DB' : '#2E7D32',
              borderRadius: 10,
              alignItems: 'center',
              justifyContent: 'center',
            }}
